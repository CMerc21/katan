...
- **Robber:** cone body `#2B2118` height 0.22 R, second cone hood, off-white face plate quad with two dark eye dots, ochre sphere sack `#E8B84A` at the side, round base disc dark grey.
