...
export function Sheet({ title, children, testId }: { title: string; children: ReactNode; testId: string }) {
  return (
    <div className="hud-panel hud-dark absolute bottom-3 left-1/2 z-10 w-[min(28rem,calc(100%-1.5rem))] -translate-x-1/2 rounded-md p-3" role="dialog" aria-label={title} data-testid={testId}>
